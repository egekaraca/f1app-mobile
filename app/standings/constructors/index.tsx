...
export default function ConstructorStandingsScreen() {
  ...
  if (isLoading) return <Centered message="Takım puan durumu yükleniyor…" />;
  if (isError || !data) return <Centered message="Veri alınamadı. Tekrar dene." onRetry={refetch} />;
  ...
  return (
    <View style={{ flex: 1, padding: 16 }}>
      ...
      <FlatList
        data={data}
        keyExtractor={(it) => it.Constructor.constructorId}
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontWeight: "700" }}>{item.Constructor.name}</Text>
            </View>
